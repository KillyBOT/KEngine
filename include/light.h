...
pixel_t ref_phong_a (byte_t alight[3], mtl_t* mat, double t[2]);
pixel_t ref_phong_d (Vec4_t* n, mtl_t* mat, double t[2]);
pixel_t ref_phong_s (Vec4_t* n, Vec4_t* v, mtl_t* mat, double t[2]);

pixel_t ref_blinn(Vec4_t* n, Vec4_t* v, byte_t alight[3], mtl_t* mat, double t[2] );

pixel_t ref_blinn_a (byte_t alight[3], mtl_t* mat, double t[2]);
